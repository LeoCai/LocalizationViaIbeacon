...
public class TrainTagActivity extends Activity implements BeaconBasedPosListener, View.OnTouchListener, CuIndexSetter {
    private final static String TAG = "DeviceControlActivity";
    public static final String EXTRAS_DEVICE_NAME = "DEVICE_NAME";
    public static final String EXTRAS_DEVICE_ADDRESS = "DEVICE_ADDRESS";
    public static final String TAG_ADDRESS = "34:B1:F7:D5:16:11";
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            mBluetoothLeService.setBeaconBasedPosListener(TrainTagActivity.this);
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Toast.makeText(TrainTagActivity.this,"device connected",Toast.LENGTH_LONG).show();
            } else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                invalidateOptionsMenu();
                mBluetoothLeService.connect(mDeviceAddress);
                Log.d(TAG,"device disconnected");
                Toast.makeText(TrainTagActivity.this,"device disconnected",Toast.LENGTH_LONG).show();
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (myuuid.equals("fff1")) {
                    if ((charaProp & BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
                        ...
                        Toast.makeText(TrainTagActivity.this,"notifyEnabled",Toast.LENGTH_LONG).show();

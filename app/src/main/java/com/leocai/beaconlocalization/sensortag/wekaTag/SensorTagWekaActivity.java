...
import com.leocai.beaconlocalization.wekaPhone.BufferArrayLocaization;
...
public class SensorTagWekaActivity extends Activity implements BeaconBasedPosListener, View.OnTouchListener, CuIndexSetter {
    ...
    public static final String MODEL1 = "tag10.model";
    private static final String MODEL2 = "tag10.model";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceAddress = TrainTagActivity.TAG_ADDRESS;
...
//                Log.d(TAG,showInfo);
                double[] result = wekaAlgorithm.predict(dists);
                bufferLocalization.addPredict(result);
